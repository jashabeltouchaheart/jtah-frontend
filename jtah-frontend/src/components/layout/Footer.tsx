...
import { Heart, Link as LinkIcon, PhoneCall, MapPin, Mail, Smartphone, ArrowUpRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-[#3a3560]/75 leading-relaxed">
              <span className="font-semibold text-[#3a3560]">Jashabel Touch-A-Heart Foundation</span> - Touching lives since 2000. Dedicated to promoting welfare and interest of women and the girl-child.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-[#3a3560]/75">
              <div className="flex items-start gap-2.5">
                ...
                <span>No. 43, Ogunlana street, off egbeda bus stop, Lagos, Nigeria</span>
              </div>
              <div className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 text-[#7c74b2] shrink-0" />
                <a href="mailto:info@jtahfoundation.org" className="hover:text-[#7c74b2] transition-colors duration-200">
                  info@jtahfoundation.org
                </a>
              </div>
              <div className="flex items-center gap-2.5">
                <Smartphone className="w-4 h-4 text-[#7c74b2] shrink-0" />
                <a href="tel:+2348033513800" className="hover:text-[#7c74b2] transition-colors duration-200">
                  +234 803 351 3800
                </a>
              </div>
            </div>
        ...
        <div className="flex flex-col items-center justify-center space-y-6 text-center">
          ...
          <div className="space-y-1.5 text-xs text-[#3a3560]/65">
            <p>&copy; {currentYear} JASHABEL TOUCH-A-HEART FOUNDATION. All rights reserved.</p>
